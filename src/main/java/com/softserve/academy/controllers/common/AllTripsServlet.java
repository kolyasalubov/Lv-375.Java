...
/**
 * Servlet implementation class AllTripsServlet
 */
@WebServlet("/alltrips")
public class AllTripsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//Logout if session is not active
			...
			//Go to view with all trips
			getServletConfig()
				.getServletContext()
				.getRequestDispatcher(ViewUrls.ALL_TRIPS_JSP.toString())
				.forward(request, response);
		}
	}
