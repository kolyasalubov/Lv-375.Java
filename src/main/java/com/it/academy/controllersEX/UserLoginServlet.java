package com.it.academy.controllersEX;
...
import com.it.academy.controllers.ControllerUrls;
import com.it.academy.controllers.ViewUrls;
...
public class UserLoginServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (isFirstStart) {
			...
			getServletConfig()
				.getServletContext()
				.getRequestDispatcher("/initialization") // TODO
