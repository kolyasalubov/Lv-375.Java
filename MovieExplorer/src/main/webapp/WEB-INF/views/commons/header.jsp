    ...
    <div class="container">
		...
		<div class="collapse navbar-collapse" id="navbar">
			<ul class="nav navbar-nav navbar-right">
				<li class="active"><a href="${pageContext.request.contextPath}/userProfile?userId=${userDto.id}">Profile<span class="sr-only">(current)</span></a></li>
				<li class="dropdown">
			...
			<form class="navbar-form navbar-right search-form" role="search" id="searchForm" 
				  method="get" action="${pageContext.request.contextPath}/search" >
